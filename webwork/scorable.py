...
Score = namedtuple('Score', ['earned', 'possible'])
...
class ScorableXBlockMixin(object):
    ...
    def get_score(self):
        ...
        Returns:
            Score(earned=float, possible=float)
        """
        raise NotImplementedError
    ...
    def set_score(self, score):
        ...
        The score is a named tuple with a earned attribute and a
        possible attribute, reflecting the raw earned score and the maximum
        raw score the student could have earned respectively.

        Arguments:
            score: Score(earned=float, possible=float)
